...
import { AmbulantesFAQArray } from '../../../Data/Rentas/Ambulantes/AmbulantesFAQArray';

const AmbulantesFAQContainer = () => {
    return (
        <div className="container text-center justify-content-center align-items-center h-100">
            <div className="row">
                {
                    AmbulantesFAQArray.map(card => (
