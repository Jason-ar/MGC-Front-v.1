...
function CardObraActual({obra, image, ubicacion, inicio, resumen,  descripccion, link}) {
  return (
    <div className="card text-center text-dark rounded-20 animate__animated animate__fadeInUp">
      ...
      <div className="card-body text-dark">
          ...
          <p className="card-text text-secondary">{descripccion}</p>
          
      </div>
    </div>
  );
}
CardObraActual.propTypes = {
