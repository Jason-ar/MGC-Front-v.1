...
function RecoleccionCard({servicio, image, resumen, subtitulo, texto, video, link,  profesor}) {
  return (
    <div className="card text-center text-dark rounded-20 animate__animated animate__fadeInUp">
      ...
      <div className="card-body text-dark">
          ...
          <h7 className="card-sub-title">{subtitulo}</h7>
