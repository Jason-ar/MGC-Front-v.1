...
//CARD NORMAL DEKSTOP
function CardArtista({nombre, imageSource, dia, hora, lugar, rubroartista, realizado }) {
  return (
...
function PhoneCardArtista({nombre, imageSource, dia, hora, lugar, rubroartista,realizado }) {
  return (
    <div className="card text-center bg-dark rounded-20 animate__animated animate__fadeInUp">
      <div className="img-container">
          <img src={imageSource} alt="Foto hospedaje" className="card-img-top"/>
